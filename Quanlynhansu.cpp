...
public:
    ...
    friend istream& operator>>(istream& is, CongTyX &a)
    {
        ...
        is.getline(a.manv,10);
        fflush(stdin);
        cout<<"Nhap ho ten: ";
        is.getline(a.ht,30);
        cout<<"Nhap ngay sinh: ";
        is>>a.ng.ng>>a.ng.th>>a.ng.nam;
        fflush(stdin);
        cout<<"Nhap gioi tinh: ";
        is.getline(a.gt,5);
        fflush(stdin);
        ...
        is>>a.nvct.ng>>a.nvct.th>>a.nvct.nam;
        cout<<"Nhap luong: ";
        is>>a.luong;
        fflush(stdin);
        return is;
...
public:
    ...
    {
        is>>(CongTyX&)a;
        cout<<"Nhap dinh muc so luong san pham: ";
        cin>>a.dmslsp;
...
public:
    ...
    friend istream& operator>>(istream& is, NhanVienChuyenDi &a)
    {
        ...
        is>>a.ncd.ng>>a.ncd.th>>a.ncd.nam;
        fflush(stdin);
        return is;
    }
...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        case 9://Them nhan vien chuyen di
        {
            ...
            fflush(stdin);
            cout<<"\n-------------------------------------------\n";
            cout<<"Nhap ma nhan vien chuyen di: ";
            cin.getline(tenct,30);
            cout<<"-------------------------------------------\n\n\n";
            Node<NhanVienVanPhong>* tmp1 = listNhanVienVanPhong.SearchByID(tenct);
            if(tmp1!=NULL)
